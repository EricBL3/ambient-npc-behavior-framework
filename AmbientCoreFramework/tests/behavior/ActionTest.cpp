...
protected:
    void SetUp() override {
        action = std::make_unique<Action>(0, "test_action", 10, 15,
...
TEST_F(ActionTest, ConstructorWorksCorrectly)
{
    ...
    EXPECT_EQ(10, action->GetActionDuration());
