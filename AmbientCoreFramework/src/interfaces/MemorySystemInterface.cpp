...
extern "C" MemorySystemHandle CreateMemorySystem(int max_transitions, int max_actions, int max_interruptions)
{
...
extern "C" void DestroyMemorySystem(MemorySystemHandle handle)
{
    if (handle != nullptr)
    {
        PerformanceTracker::StartTiming();
...
extern "C" int GetLeastRecentlyVisitedNode(MemorySystemHandle handle, int *node_ids, int count)
{
...
extern "C" int GetLeastRecentlyUsedEntityForAction(MemorySystemHandle handle, int action_id, int *entity_ids, int count)
{
...
extern "C" int UpdateTransitionMemory(MemorySystemHandle handle, int target_node_id, int current_time)
{
    if (handle == nullptr)
    {
        return 0;
...
extern "C" int UpdateActionMemory(MemorySystemHandle handle, int action_id, int target_entity_id, int current_time)
{
    if (handle == nullptr)
    {
        return 0;
...
extern "C" int UpdateInterruptionMemory(MemorySystemHandle handle, int action_id, int sequence_id, int node_id, int entity_id, int current_time)
{
    if (handle == nullptr)
    {
        return 0;
...
extern "C" int FindTransitionMemory(MemorySystemHandle handle, int target_node_id, int *out_timestamp)
{
...
extern "C" int FindActionMemory(MemorySystemHandle handle, int action_id, int target_entity_id, int *out_timestamp)
{
    if (handle == nullptr || out_timestamp == nullptr)
    {
        return 0;
...
extern "C" int FindInterruptionMemory(MemorySystemHandle handle, int action_id, int sequence_id, int node_id, int *out_entity_id, int *out_timestamp)
{
...
extern "C" void ClearAllMemories(MemorySystemHandle handle)
{
    if (handle != nullptr)
    {
        PerformanceTracker::StartTiming();
...
extern "C" void ClearSequenceInterruptionMemories(MemorySystemHandle handle, int sequence_id)
{
    if (handle != nullptr)
    {
        PerformanceTracker::StartTiming();
...
extern "C" int GetTransitionMemoryCount(MemorySystemHandle handle)
{
    if (handle == nullptr)
    {
        return 0;
...
extern "C" int GetActionMemoryCount(MemorySystemHandle handle)
{
    if (handle == nullptr)
    {
        return 0;
...
extern "C" int GetInterruptionMemoryCount(MemorySystemHandle handle)
{
    if (handle == nullptr)
    {
        return 0;
